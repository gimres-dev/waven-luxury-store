            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  const TSettingsMenuTile(icon:Iconsax.notification_bing, title: 'Notifications', subTitle: 'Set any kind of notification message'),
                  const TSettingsMenuTile(icon:Iconsax.shield_tick, title: 'Account Privacy', subTitle: 'Manage data usage and connected accounts'),
